...
#define MIN(a, b) ((a) < (b) ? a : b)
    ...
    struct NCAng1d
    { // normal constrained feasible angle for 1D rotation search
        int n;
    ...
    struct corrTab
    {              // correspondence table, including the indices in corrIdx and the upperbound
    ...
    struct corrTabWithNC
    { // union of correspondence table and normal constrains
        corrTab corr;
        NCAng1d NC;
    };
     ...
     */
    inline void matrixMultipy(double *R, double *X, double *C, int n)
    {
        assert(n > 0 && "");
        // char *chn = (char *)"N";
        double alpha = 1.0, beta = 0.0;
    ...
    inline void fromAxisAngle(Matrix3 &R, const AxisAngle &a)
    {
